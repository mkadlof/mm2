...
public class TrajectoryAndStats {
	...
	private int trajFrameNumber;
	private int energyFrameNumber;

	private final int BUFFER_SIZE = 10000; 


	public TrajectoryAndStats(int nOfAtoms, int nOfSteps) { 
		traj = new VecNd[nOfAtoms][BUFFER_SIZE]; // wprowadzilem to ograniczenie, zeby nie zajac przypadkiem calej pamieci w przypadku bardzo dlugiej symulacji
	...
	public void updateEnergy(TheSystem system) {
		...
		eKin[energyFrameNumber] = system.getKinEnergy();
